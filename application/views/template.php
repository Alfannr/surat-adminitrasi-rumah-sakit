  ...
  <body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
      ...
      <!--      
            ...
            <li>
              <?php echo anchor('agenda','<i class="fa fa-calendar"></i> <span>Agenda</span>'); ?>
            </li>
            ...
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                    ...
                    <li>
                        <?php echo anchor('kategori_agenda','<i class="fa fa-circle"></i> <span>Kategori Agenda</span>'); ?>
                    </li>
                </ul>
            </li>
<!--
            <li>
              <?php echo anchor('kategori_agenda','<i class="fa fa-list"></i> <span>Kategori Agenda</span>'); ?>
            </li> -->
